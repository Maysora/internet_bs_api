...
module InternetBsApi
  module Utilities
    ...
    def validate_email(email_address)
      !(email_address =~ /^[a-zA-Z][\w\.-]*[a-zA-Z0-9]@[a-zA-Z0-9][\w\.-]*[a-zA-Z0-9]\.[a-zA-Z][a-zA-Z\.]*[a-zA-Z]$/)
    end
    ...
    def validate_list(fields_list)
      ...
      fields_list.each do |l|
        raise InternetBsApi::ValidationListEntry.new("Bad fields list for nested Array!") if (l.class != Array or l.size != 3)
      end
      ...
      if bad_fields.length > 0
        raise InternetBsApi::InvalidInputParameters.new("Required parameters missing: #{bad_fields}")
      end
    end
